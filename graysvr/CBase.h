...
public:
	...
	{
		if ( ResLevel >= RDS_PRET2A && ResLevel < RDS_QTY )
		{
			m_ResLevel = ResLevel;
			return true;
		}
...
enum IT_TYPE		// double click type action.
{
	...
	IT_CRYSTAL_BALL,		// 86
	IT_UNUSED_87,			// 87 = <unused> (was IT_OLD_CASHIERS_CHECK represents large amounts of money)
	...
	IT_UNUSED_91,			// 91 = <unused> (was IT_DREAM_GATE, purposed to move to another server)
