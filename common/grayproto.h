...
enum XCMD_TYPE	// XCMD_* messages are unique in both directions.
{
	...
	XCMD_ViewRange		= 0xc8,
	XCMD_AreaServerPing	= 0xc9,
	XCMD_UserServerPing	= 0xca,
	XCMD_GQCount		= 0xcb,
	//
	//
	//
...
enum EXTDATA_TYPE
{
	...
	EXTDATA_EquipInfo		= 0x10, // Equip info
	//
	//
...
union CExtData
{
	...
	struct  // EXTDATA_EquipInfo
	{
		NDWORD m_Uid;
		NWORD m_CrafterLenght;
		char m_CrafterName[1]; // MAX m_CrafterLenght
		struct
		{
			NWORD m_Prop;
			NWORD m_Charge;
