...
enum HUE_CODE
{
	...
	HUE_BLACKMETAL	= 0x044e,	// Sort of a dark gray.
...
#define SKILL_SCRIPTED SKILL_SCRIPTED00
	...
	NPCACT_GO_HOME,			// 109 =
	NPCACT_GO_FETCH,		// 110 = Pick up a thing. Command as pet. m_Act_Targ
	NPCACT_BREATH,			// 111 = Using breath weapon. on m_Act_Targ
	NPCACT_RIDDEN,			// 112 = Being ridden or shrunk as figurine.
	NPCACT_UNUSED,			// 113 = was eating before
	NPCACT_LOOTING,			// 114 = Looting a corpse. m_Act_Targ
	NPCACT_THROWING,		// 115 = Throwing a stone at m_Act_Targ.
	NPCACT_GO_OBJ,			// 116 = walking to an object i want. m_Act_Targ
...
public:
	...
	bool Load(int map, int maxx, int maxy, int sectorsize, int realmapnum);
...
struct CUOHueGroup // HUE.MUL
{
	...
	struct CUOHueEntry
	{
		...
		WORD m_TableEnd;
		char m_Name[20];
	} m_Entries[UOHUE_BLOCK_QTY] PACK_NEEDED;
} PACK_NEEDED;
